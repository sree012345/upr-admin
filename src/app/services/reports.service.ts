...
export class ReportsService {
  ...
  usersecurity()
  {
    console.log(this.APIBaseUrl + 'AdminUser/view_registered_users', { company_id: 1 });
    return this.http.post<any>(this.APIBaseUrl + 'AdminUser/view_registered_users', { company_id: 1 });
