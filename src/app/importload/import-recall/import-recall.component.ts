...
@Component({
  selector: 'app-import-recall',
  templateUrl: './import-recall.component.html',
  styleUrls: ['./import-recall.component.css']
})
export class ImportRecallComponent implements OnInit {
  SERVER_URL = "http://34.204.86.142:3002/uprserver/api/v1/import/import_add_recall";
